    ...
    <div id="centerLayer">
        ...
        <div id="textLayer">
				...
				<?php
					...
					connect();
					$query='SELECT * FROM prize WHERE idPrize="'.$_GET['idPrize'].'"';
					$results=mysql_query($query);
					$row=mysql_fetch_array($results);

				echo '
				<form enctype="multipart/form-data" id="formLayer" name="formModifyNew" action="../PHP/actualizarTrofeo.php?idPrize='.$_GET['idPrize'].'" onReset="return confirmReset()" method="post">
					...
					<label>Name:</label><br><input type="text" name="name" value="'.stripslashes($row['namePrize']).'" size="40"><br><br>
               		<!-- Upload Image -->	
