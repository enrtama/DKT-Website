...
<div id="capaContenido">
    ...
    <div id="capaCentro">
        ...
        <div id="capaTexto">
      	      <p class="infoForm">Complete el formulario con sus datos personales</p>
        	  	<form enctype="multipart/form-data" method="post" action="./Usuario/insertaUsuario.php" name="register" onSubmit="return validar_formulario(register)" onReset="return resetear()">
            	<br><fieldset id="capaDatosPersonales">
                    ...
                    <label>Fecha Nacimiento: </label><br><input name="datepicker" id="datepicker" size="20"/><br><br>
                </fieldset>
                <fieldset id="capaDatosLocalizacion">
                	<legend> Datos de Localización </legend>
                  	<label>Direccion: </label> <br>
                    	<input type="text" name="address" value="" maxlength="50" size="50"><br>                    
                    <label>Telefono: </label> <br>
                    	<input type="text" name="phone" value="" maxlength="9" onBlur="telefono_valido(this.value)"><br>
                    <label>Correo Electronico: </label> <br>
                    	<input type="text" name="mail" value="" maxlength="50" size="50" onBlur="correo_valido(this.value)"><br><br>
                </fieldset>
