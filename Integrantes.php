...
<div id="capaContenido">
        ...
        <div id="capaMenu">
                ...
                <?php
					if (isset($_SESSION["sessionUser"])){
				    	...
				    	echo '<li id="botonMenuSeleccionado"> <a href="/Integrantes.php"> Integrantes </a> </li>';
					}
				?>
             </ul>
            <!--fin lista menu -->
    ...
    <div id="capaCentro">
        ...
        <div id="capaTexto">
           	<?php
                include_once($_SERVER['DOCUMENT_ROOT']."/Usuario/mostrarUsuarios.php");
            	showMembers();
            ?>
        </div>
        <!-- fin capa texto -->
