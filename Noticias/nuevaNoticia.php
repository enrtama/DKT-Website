...
<div id="contentLayer">      
    ...
    <div id="centerLayer">
		...
		<?php		
			echo '	<form id="formLayer" name="formModifyNew" action="./insertarNoticia.php?menu='.$_GET['menu'].'" onReset="return confirmReset()" method="post"> ';		
		?>
					<fieldset id="personalData">
					<legend>News Information</legend><br>
					...
					<label>Title:</label><br><input type="text" name="title" value="" size="70"><br><br>
					<label>Date: </label><br><input name="datepicker" id="datepicker" size="10"/><br><br>
					<label>Time:</label><br><input type="text" name="time" value="" size="10" maxlength="5"><br><br>
					<label>Content:<br>(Load Image first)</label><br><textarea id="elm1" name="elm1" rows="15" cols="80" style="width: 400px" type="textarea" name="content" rows="6" cols="40" wrap="soft"></textarea><br><br>
				</fieldset><br><br>
